...
[![version](https://img.shields.io/badge/v3.3.0-Learning%20Cockpit%20Reframe-E8D5B5?style=flat-square&labelColor=3a3026&color=E8D5B5)](https://github.com/TiM1113/llm-wiki-skill/releases)
...
| Optional | Web articles, X/Twitter, YouTube | Auto-extract via adapters; manual fallback if extraction fails |
...
- Optional: `bun` or `npm` for web extraction; Chrome debug mode (port 9222) for authenticated sessions
...
Yes. `/llm-wiki-upgrade` updates the core. Add `--with-optional-adapters` to also refresh web/X/YouTube extraction.
